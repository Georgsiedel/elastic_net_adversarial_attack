...
if __name__ == '__main__':
    ...
    os.system("python attack_comparison.py --learning_rate=0.5 --beta=2.0 --track_distance=True --dataset=imagenet --model=Salman2020Do_R50 --epsilon_l1=100 --max_iterations=100 --attack_types exp_attack_L1_rule_higher_beta")
