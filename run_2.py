...
if __name__ == '__main__':
    ...
    os.system("python attack_comparison.py --max_batchsize=200 --learning_rate=0.5 --beta=1.0 --track_distance=True --dataset=imagenet --model=ConvNext_iso_CvSt_revisiting --epsilon_l1=100 --max_iterations=100 --attack_types exp_attack")
    ...
    os.system("python attack_comparison.py --max_batchsize=200 --learning_rate=0.2 --beta=2.0 --track_distance=True --dataset=imagenet --model=ConvNext_iso_CvSt_revisiting --epsilon_l1=75 --max_iterations=100 --attack_types exp_attack_L1_rule_higher_beta")
