...
if __name__ == '__main__':
    ...
    "--hyperparameter_range 2.0 4.0 --attack_type=exp_attack_l1 --epsilon_l1=12 ")
    ...
    "--hyperparameter_range 1.0 2.0 3.0 5.0 6.0 7.0 8.0 10.0 15.0 20.0 --attack_type=exp_attack_l1 --epsilon_l1=12 ")
