...
if __name__ == '__main__':
    ...
    os.system("python hyperparameter_sweep.py --max_batchsize=5 --track_c=True --hyperparameter_range1 0.1 0.2 0.5 1.0 2.0 --hyperparameter_range2 0.05 0.1 0.2 0.5 1.0 --dataset=cifar10 --model=corruption_robust --attack_type exp_attack_l1_linf --epsilon_l1=2 --max_iterations=100")

    os.system("python hyperparameter_sweep.py --max_batchsize=5 --track_c=True --hyperparameter_range1 0.2 0.5 1.0 2.0 5.0 --hyperparameter_range2 0.1 0.2 0.5 1.0 2.0 5.0 --dataset=cifar10 --model=MainiAVG --attack_type exp_attack_l1_linf --epsilon_l1=12 --max_iterations=100")
    ...
    os.system("python hyperparameter_sweep.py --max_batchsize=5 --track_c=True --hyperparameter_range1 0.2 0.5 1.0 2.0 5.0 --hyperparameter_range2 0.05 0.1 0.2 0.5 1.0 2.0 5.0 --dataset=cifar10 --model=MainiAVG --attack_type exp_attack --epsilon_l1=12 --max_iterations=100")

    os.system("python hyperparameter_sweep.py --max_batchsize=5 --track_c=True --hyperparameter_range1 0.5 1.0 2.0 5.0 --hyperparameter_range2 0.05 0.1 0.2 0.5 1.0 2.0 5.0 --dataset=cifar10 --model=CroceL1 --attack_type exp_attack --epsilon_l1=12 --max_iterations=100")

    os.system("python hyperparameter_sweep.py --max_batchsize=5 --track_c=True --hyperparameter_range1 0.1 0.2 0.5 1.0 2.0 --hyperparameter_range2 0.01 0.02 0.05 0.1 0.2 0.5 --dataset=cifar10 --model=standard --attack_type exp_attack_L1_rule_higher_beta --epsilon_l1=2 --max_iterations=100")
