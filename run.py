...
if __name__ == '__main__':
    ...
    os.system("python attack_comparison.py --dataset=imagenet --model=standard --beta=3.0 --learning_rate=1.25 --attack_types brendel_bethge exp_attack_l1")

    os.system("python attack_comparison.py --dataset=imagenet --model=Salman2020Do_R50 --beta=7.0 --learning_rate=2.25 --attack_types brendel_bethge exp_attack_l1")
