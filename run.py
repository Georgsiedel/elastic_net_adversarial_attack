...
if __name__ == '__main__':
    ...
    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=learning_rate --hyperparameter_range 0.1 --dataset=imagenet --model=vgg19 --attack_type ead_fb --epsilon_l1=12 --max_iterations=100")
    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=learning_rate --hyperparameter_range 0.1 --dataset=imagenet --model=vgg19 --attack_type ead_fb_L1_rule_higher_beta --epsilon_l1=12 --max_iterations=100")
    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=learning_rate --hyperparameter_range 0.1 --dataset=imagenet --model=vgg19 --attack_type ead_fb --epsilon_l1=12 --max_iterations=300")
    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=learning_rate --hyperparameter_range 0.1 --dataset=imagenet --model=vgg19 --attack_type ead_fb_L1_rule_higher_beta --epsilon_l1=12 --max_iterations=300")
    ...
    os.system("python hyperparameter_sweep.py --hyperparameter=learning_rate --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=imagenet --model=ConvNext_iso_CvSt_revisiting --attack_type exp_attack_l1 --epsilon_l1=75 --max_iterations=100")
    os.system("python hyperparameter_sweep.py --hyperparameter=beta --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=imagenet --model=ConvNext_iso_CvSt_revisiting --attack_type exp_attack_l1 --epsilon_l1=75 --max_iterations=100")

    os.system("python hyperparameter_sweep.py --hyperparameter=learning_rate --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=imagenet --model=DVCE_R50 --attack_type exp_attack_l1 --epsilon_l1=255 --max_iterations=100")
    os.system("python hyperparameter_sweep.py --hyperparameter=beta --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=imagenet --model=DVCE_R50 --attack_type exp_attack_l1 --epsilon_l1=255 --max_iterations=100")

    os.system("python hyperparameter_sweep.py --hyperparameter=learning_rate --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=imagenet --model=Salman2020Do_R50 --attack_type exp_attack_l1 --epsilon_l1=12 --max_iterations=100")
    os.system("python hyperparameter_sweep.py --hyperparameter=beta --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=imagenet --model=Salman2020Do_R50 --attack_type exp_attack_l1 --epsilon_l1=12 --max_iterations=100")
    ...
    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=learning_rate --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=cifar10 --model=MainiAVG --attack_type exp_attack --epsilon_l1=12 --max_iterations=100")
    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=beta --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=cifar10 --model=MainiAVG --attack_type exp_attack --epsilon_l1=12 --max_iterations=100")

    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=learning_rate --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=cifar10 --model=standard --attack_type exp_attack --epsilon_l1=2 --max_iterations=100")
    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=beta --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=cifar10 --model=standard --attack_type exp_attack --epsilon_l1=2 --max_iterations=100")

    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=learning_rate --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=cifar10 --model=CroceL1 --attack_type exp_attack --epsilon_l1=12 --max_iterations=100")
    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=beta --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=cifar10 --model=CroceL1 --attack_type exp_attack --epsilon_l1=12 --max_iterations=100")

    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=learning_rate --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=cifar10 --model=corruption_robust --attack_type exp_attack --epsilon_l1=2 --max_iterations=100")
    os.system("python hyperparameter_sweep.py --track_c=True --hyperparameter=beta --hyperparameter_range 0.02 0.05 0.1 0.2 0.5 1.0 2.0 --dataset=cifar10 --model=corruption_robust --attack_type exp_attack --epsilon_l1=2 --max_iterations=100")
