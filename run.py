...
if __name__ == '__main__':
    ...
    os.system("python attack_comparison.py --model=standard --epsilon_l1=12")

    os.system("python attack_comparison.py --model=corruption_robust --epsilon_l1=12")
    
    os.system("python attack_comparison.py --model=MainiAVG --epsilon_l1=4")

    os.system("python attack_comparison.py --dataset=imagenet --model=standard --epsilon_l1=50")
