...
if __name__ == '__main__':
    ...
    os.system("python attack_comparison.py --track_distance=True --track_c=True --beta=5.0 --learning_rate=1.5 --max_iterations=300 --dataset=imagenet --model=ConvNext_iso_CvSt_revisiting --epsilon_l1=12 --attack_types exp_attack_l1 exp_attack_l1_linf ead_fb ead_fb_L1_rule_higher_beta")
    ...
    os.system("python attack_comparison.py --track_distance=True --track_c=True --beta=5.0 --learning_rate=1.5 --max_iterations=500 --dataset=imagenet --model=ConvNext_iso_CvSt_revisiting --epsilon_l1=12 --attack_types exp_attack_l1 exp_attack_l1_linf ead_fb ead_fb_L1_rule_higher_beta")
    ...
    os.system("python attack_comparison.py --track_distance=True --track_c=True --beta=2.0 --learning_rate=2.0 --max_iterations=300 --dataset=imagenet --model=DVCE_R50 --epsilon_l1=12 --attack_types exp_attack_l1 exp_attack_l1_linf ead_fb ead_fb_L1_rule_higher_beta")
    ...
    os.system("python attack_comparison.py --track_distance=True --track_c=True --beta=2.0 --learning_rate=2.0 --max_iterations=500 --dataset=imagenet --model=DVCE_R50 --epsilon_l1=12 --attack_types exp_attack_l1 exp_attack_l1_linf ead_fb ead_fb_L1_rule_higher_beta")
