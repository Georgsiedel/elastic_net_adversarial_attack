...
if __name__ == '__main__':
    ...
    os.system("python hyperparameter_sweep.py --hyperparameter=learning_rate --hyperparameter_range 0.5 1.0 1.5 2.0 3.0 --dataset=imagenet --model=DVCE_R50 --epsilon_l1=255 --max_iterations=100 --attack_type=exp_attack_l1")
    os.system("python hyperparameter_sweep.py --hyperparameter=beta --hyperparameter_range 1.0 2.0 3.0 5.0 10.0 20.0 --dataset=imagenet --model=DVCE_R50 --epsilon_l1=255 --max_iterations=100 --attack_type=exp_attack_l1")

    os.system("python attack_comparison.py --max_batchsize=100 --beta=0.01 --learning_rate=1.0 --max_iterations=100 --dataset=cifar10 --model=standard --epsilon_l1=2 --attack_types exp_attack_l1 exp_attack_l1_linf")
    os.system("python attack_comparison.py --max_batchsize=100 --beta=0.01 --learning_rate=1.0 --max_iterations=100 --dataset=cifar10 --model=standard --epsilon_l1=4 --attack_types exp_attack_l1 exp_attack_l1_linf exp_attack exp_attack_L1_rule_higher_beta")
    ...
    os.system("python attack_comparison.py --max_batchsize=100 --beta=0.01 --learning_rate=1.0 --max_iterations=300 --dataset=cifar10 --model=standard --epsilon_l1=2 --attack_types exp_attack_l1 exp_attack_l1_linf")
    ...
    os.system("python attack_comparison.py --max_batchsize=100 --beta=0.01 --learning_rate=1.0 --max_iterations=500 --dataset=cifar10 --model=standard --epsilon_l1=2 --attack_types exp_attack_l1 exp_attack_l1_linf")
    ...
    os.system("python attack_comparison.py --max_batchsize=100 --beta=0.5 --learning_rate=2.0 --max_iterations=100 --dataset=cifar10 --model=MainiAVG --epsilon_l1=2 --attack_types exp_attack_l1 exp_attack_l1_linf")
    ...
    os.system("python attack_comparison.py --max_batchsize=100 --beta=0.5 --learning_rate=2.0 --max_iterations=100 --dataset=cifar10 --model=MainiAVG --epsilon_l1=12 --attack_types exp_attack_l1 exp_attack_l1_linf exp_attack exp_attack_L1_rule_higher_beta")
    ...
    os.system("python attack_comparison.py --max_batchsize=100 --beta=0.5 --learning_rate=2.0 --max_iterations=100 --dataset=cifar10 --model=CroceL1 --epsilon_l1=2 --attack_types exp_attack_l1 exp_attack_l1_linf")
    ...
    os.system("python attack_comparison.py --max_batchsize=100 --beta=0.5 --learning_rate=2.0 --max_iterations=100 --dataset=cifar10 --model=CroceL1 --epsilon_l1=12 --attack_types exp_attack_l1 exp_attack_l1_linf exp_attack exp_attack_L1_rule_higher_beta")
